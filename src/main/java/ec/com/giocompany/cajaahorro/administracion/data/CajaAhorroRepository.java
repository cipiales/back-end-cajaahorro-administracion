...
@Slf4j
public class CajaAhorroRepository {

    private final CajaAhorroJpaRepository repository;
    ...
    public List<CajaAhorro>  getCajasAhorro(String  codigoCajaAhorro, String nombreCajaAhorro,String estado) {
        SearchCriteria<CajaAhorro> spec = new SearchCriteria<>();
        ...
        if (!Objects.equals(nombreCajaAhorro, "")) {
            spec.add(new SearchStatement("nombreCajaAhorro", nombreCajaAhorro,SearchOperation.EQUAL));
        }
        List<CajaAhorro> resultados = repository.findAll(spec);
        return resultados;
    }

    public CajaAhorro save(CajaAhorro cajaAhorro) {
        return repository.save(cajaAhorro);
    }
